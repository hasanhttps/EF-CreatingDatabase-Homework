    ...
    public partial class First : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BooksStudents", x => new { x.BooksId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_BooksStudents_Books_BooksId",
                        column: x => x.BooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BooksStudents_Students_StudentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BooksStudents_StudentsId",
                table: "BooksStudents",
                column: "StudentsId");
        }
